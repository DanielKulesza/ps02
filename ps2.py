...
def traffic_light_detection(img_in, radii_range):
    ...
    circles = cv2.HoughCircles(gray_img,cv2.cv.CV_HOUGH_GRADIENT,0.75,10,param1=20,param2=10,minRadius=radii_range[0],maxRadius=radii_range[0] + len(radii_range))
    #print circles
    result = ()
    x = 0
    y = 0
            ...
            for line2 in angle_map["135"]:
                for line3 in angle_map["45"]:
                    for line4 in angle_map["135"]:
                        ...
                        #print verticies
                        #find centroid
                        centroid = np.uint16(((verticies[0][0] + verticies[1][0] + verticies[2][0] + verticies[3][0])/4,
